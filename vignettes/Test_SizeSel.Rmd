...
Next, run the Size-Frequency (SF) analysis for each species. First tabulate 
...
Then, conduct full gear Size-Selectivity Analysis, as in Kotwicki et al. 
(2017, Fish. Res. 191:76-86). We use their approach # 1 (their equations 
1-4), where effort data is available and comparable between gears, so size 
distributions are compared on the basis of CPUE. We choose their "SSCM" method, 
as that provides the most flexible curve-fitting, and in their analysis had 
the best fit in all cases. Their equations assume a paired-trawl or split-
trawl experimental design, so adjustments must be made for our stratified 
design.
